...
export const cards: readonly CardData[] = [
  ...
  },
  {
    ...
    cashbackMin: 0,
    annualFee: "Free",
    fxFee: "0% (direct pairs) / 0–1.5% (indirect pairs)",
    perks: [
      "Up to 8% cashback",
      "5% APY on spendable balances, no lockups, no staking",
      "50% back on Claude, Netflix, Spotify, and 10 other subscriptions",
      "Personal IBAN account for receiving salary and transfers",
    ],
    signupBonus: "None",
    custody: "Non-Custodial",
    regions: "Global",
    ...
    tierColor: "text-white",
    metal: false,
    supportedAssets: "USDT, USDC, EURC",
    kyc: "Required",
    supportedCurrencies: ["EUR", "USD", "GBP"],
    age: "2023",
    airdropFarming: "False",
  ...
  },
  {
    ...
    perks: [
      "Mobile Pay support",
      "IBAN/SWIFT support with free global transfers",
      "Multi-blockchain support (Ethereum, Base, Arbitrum, Optimism, Polygon)",
    ],
    signupBonus: "None",
    custody: "Self-Custody",
  ...
  },
  {
    id: "picnic-card",
    name: "Picnic",
    issuer: "Picnic - Gnosis Pay",
    isVerified: true,
    logo: getCardLogo("picnic-card"),
    type: "Debit",
    network: "Visa",
    cashbackMax: 0,
    cashbackMin: 0,
    ...
    fxFee: "0%-0.5%",
    perks: [
      "Self-custody Smart Wallet powered by Safe (securing $70B+ in digital assets)",
    ...
    custody: "Self-Custody",
    regions: "Brazil",
    officialLink: "https://usepicnic.com/",
    cardGradient: "from-[#1B4D3E] to-[#0D2B22]",
    tierColor: "text-green-400",
    metal: false,
    supportedAssets: "USDC on Gnosis Chain, 80+ networks via cross-chain bridging",
    kyc: "Required",
  ...
  },
  {
    ...
    issuer: "Rain",
    isVerified: true,
    logo: getCardLogo("moto-card"),
    type: "Credit",
    network: "Visa",
    cashbackMax: 5,
    cashbackMin: 2,
    annualFee: "TBA",
    fxFee: "Standard Visa FX (Access), first $10,000 covered (Private)",
    perks: [
      "Up to 5% cashback on first $1,000 in spend",
      "VIP concierge and luxury hotel + flight discounts",
      "Travel credits and airport lounge access",
      "Visa Infinite benefits: concierge, travel protection, insurance, doctor consultations",
      "Exclusive benefits coming soon",
    ],
    signupBonus: "None",
    custody: "Non-Custodial",
    regions: "Global",
    officialLink: "https://moto-card.com",
    cardGradient: "from-[#0A0A0A] to-[#2D2D2D]",
    tierColor: "text-white",
    metal: true,
    supportedAssets: "USDC, USDT (all major chains), fiat",
    kyc: "Light",
    supportedCurrencies: ["USD"],
    age: "2026-03",
    airdropFarming: "True",
