...
export const cards: readonly CardData[] = [
  ...
  },
  {
    ...
    fxFee: "Not specified",
    perks: [
      "Spend crypto at any Visa merchant",
      "Auto-convert crypto to ARS at point of sale",
      "Cashback in Bitcoin on every purchase",
      "No annual or maintenance fees",
      "Available throughout Argentina",
    ],
    signupBonus: "None",
    custody: "Custodial",
    regions: "Argentina",
    officialLink: "https://www.lemon.me/",
